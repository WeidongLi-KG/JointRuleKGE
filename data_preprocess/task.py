...
class Task:
    ...
    def _get_model(self):
        ...
        kwargs = {
            ...
            "wpe": np.random.random_sample((self.embedding.position_size, self.hparams.wpe_dim)),#shape = (61,20)
...
def parse_args(parser):
    parser.add_option("-m", "--model", type="string", dest="model_name",default="best_nfetc_ontonotes")
    parser.add_option("-d", "--data", type="string", dest="data_name",default="ontonotes")
